        ...
        <nav class="navbar navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="pendingJobDetail.php?jobid=#0098"> Job Details</a>
                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10 col-md-offset-1">
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input type="text" name="jobId" class="form-control" value="#0051" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
